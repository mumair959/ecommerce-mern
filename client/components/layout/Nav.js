                                                ...
                                                <>
                                                    <li>
                                                        <Link href="/account/dashboard">
                                                            <span className="me-2"><i className="fa-solid fa-user"></i></span>My Account
                                                        </Link>
                                                    </li>
                                                    <li>
                                                        <a onClick={logoutHandler}><span className="me-2"><i className="fa-solid fa-arrow-right-from-bracket"></i></span>Sign Out</a>
                                                    </li>
                                                </>
                                                ) : 
                                                (
